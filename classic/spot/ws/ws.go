// Package ws implements KuCoin Classic Spot/Margin's WebSocket
...
// Client fetches Classic Spot/Margin WebSocket connection tokens.
type Client struct {
	executor *transport.Executor
}

// NewClient wires a ws.Client to the shared Classic Executor. Not
...
// GetPublicToken returns a token for opening a public Spot/Margin
// WebSocket connection (ticker, orderbook, klines, trades, etc.). No
...
// GetPrivateToken returns a token for opening a private Spot/Margin
// WebSocket connection (order/balance channels).
//
// Docs: https://www.kucoin.com/docs-new/websocket-api/base-info/get-private-token-spot-margin
